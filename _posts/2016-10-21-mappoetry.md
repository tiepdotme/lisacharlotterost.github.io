...
Wyoming is boring. Nobody cares about Wyoming. I don't know that because I asked people or because I was there, but because I looked at the maps that people drew of the United States.

![image](/pic/161020_mappoetry5.png)

I found 48 of these maps, and 17 people forgot to draw Wyoming in the first place. (Nobody forgot about California or Florida.) Well, this person included Wyoming:
...
And it's important to notice that it's an experience he talks about. What he describes is highly subjective (not as objective as most maps try to appear).
...
And in the best case, poetry doesn't just result in a rational interpretation, but evokes a feeling in the reader. As a piece of art, a poem is sublime.

Map Poetry (how I define it) has all these traits, especially the first two ones. Map Poetry doesn't give us the overview, how maps usually do it, but focus on subset of the world and look at it from a subjective stand point instead from a seemingly objective god perspective. Map Poetry makes us aware that the territory out there is, indeed, complicated, and complex and entangled. And that we all perceive it differently.
...
However, it gets really interesting when we change geographical map to show our internal map. Hand-drawn maps like the ones from the United States I showed at the beginning are excellent for that.
...
And if we get one step further, we don't just map the world as it feels – but re-imagine the world based on how we feel. One example for that is Sarah Michael Levine's "San Hoboyorkesey", which I really like. She combined maps from all the cities she has lived in: Hoboken, Jersey City, Manhattan, San Francisco. Sarah created her own personal "Sarah city", in which she has the best of all the worlds she lived in. "All maps are fictional and sentimental, this one just a little more.", she writes about her map.
...
These are just some questions that Map Poetry asks. It can make us more away of all the things that geographical and internal maps cut away. I think we need more of that. I'll try to create more of Map Poetry – and I'd be happy if you'd did the same. So that we can compare them. And then alter our internal maps.
